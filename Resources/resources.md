...
- [Best Practices for Opening Files in Python](https://stackoverflow.com/questions/5250744/difference-between-open-and-codecs-open-in-python/22288895#22288895)

- [Correlation](https://en.wikipedia.org/wiki/Correlation_and_dependence#/media/File:Correlation_examples2.svg)
- [CTR (Click Through Rate)](https://en.wikipedia.org/wiki/Click-through_rate)
- [Chart Guide](https://chart.guide/wp-content/uploads/2019/10/ChartGuide-402-web.pdf)
...
- [Github Markdown syntax](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet)
...
- [Managing Virtual Environment with Conda](https://docs.conda.io/projects/conda/en/latest/user-guide/tasks/manage-environments.html#managing-environments)
- [Managing virtual environmnt with Pip](https://docs.python.org/3/tutorial/venv.html)
...
- [Outliers](http://d-scholarship.pitt.edu/7948/1/Seo.pdf)
